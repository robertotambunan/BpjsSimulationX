...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'kdKelas'); ?>
		<?php echo $form->textField($model,'kdKelas',array('size'=>50,'maxlength'=>50)); ?>
		<?php echo $form->error($model,'kdKelas'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'nmKelas'); ?>
		<?php echo $form->textField($model,'nmKelas',array('size'=>50,'maxlength'=>50)); ?>
		<?php echo $form->error($model,'nmKelas'); ?>
	</div>
